...
$direccion = ($orden === 'desc') ? 'asc' : 'desc';

$stmt = $conexion->query("SELECT id, titulo, contenido, fecha_creacion, imagen FROM Entradas ORDER BY fecha_creacion $orden");
    ...
    <center>
        ...
        <table>
            <tr>
                ...
                <th>
                    Fecha de Creación
                    <a href="?orden=<?php echo $direccion; ?>">
                        <?php if ($orden === 'desc') : ?>
                            ▲
                        <?php else : ?>
                            ▼
